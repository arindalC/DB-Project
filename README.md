...
**Nota**: Asegúrate de guardar el archivo `.csv` antes de comenzar. Se encuentra es: [Base de datos](https://github.com/arindalC/DB-Project/blob/main/Road%20Accident%20Data.csv.zip)
